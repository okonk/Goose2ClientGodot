...
**Repo:** this one. Branch off `master` for the work; `master` currently carries unrelated
uncommitted UI changes, so keep any commit to the paths this plan names.

**Companion plan:** the `gooseserver` repo ships the field —
`docs/plans/2026-09-19-item-tooltip-extra-stats.md` — with the design beside it as
`docs/plans/2026-09-19-item-tooltip-extra-stats-design.md`.
